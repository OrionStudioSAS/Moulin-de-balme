    ...
    <>
      ...
      >
        ...
        <div className="flex items-center justify-between px-6 py-5 border-b border-brown/10">
          ...
          <button
            onClick={() => setOpen(false)}
            className="w-8 h-8 flex items-center justify-center text-brown/50 hover:text-brown transition-colors"
            aria-label="Fermer"
          >
            ✕
          </button>
        ...
        {/* Footer */}
        {items.length > 0 && (
          <div className="border-t border-brown/10 px-6 py-5 space-y-4">
