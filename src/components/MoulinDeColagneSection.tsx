  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="lg:self-end lg:pl-3">
          <p
            className="max-w-[560px] text-[15px] leading-[22px] md:max-w-[560px] lg:max-w-[506px] lg:text-[13px] lg:leading-[15.6px]"
          ...
          {content.cta && (
            <a
              ...
              className="mt-7 inline-flex h-11 min-w-[280px] items-center justify-center border border-brown px-12 text-[11px] font-semibold uppercase leading-[14px] tracking-[0.15em] text-brown transition-colors duration-150 hover:bg-brown hover:text-cream focus-visible:outline focus-visible:outline-2 focus-visible:outline-gold focus-visible:outline-offset-2 motion-reduce:transition-none md:mt-6 lg:mt-7"
              data-testid="moulin-de-colagne-cta"
            >
              {content.cta.label}
            </a>
          )}
